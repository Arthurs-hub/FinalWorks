...
class Router
{
    private array $routes = [
        ...
        '/api/2fa/generate-secret' => ['POST' => ['App\Controllers\TwoFactorController', 'generateSecret']],
        '/api/2fa/send-email-code' => ['POST' => ['App\Controllers\TwoFactorController', 'sendEmailCode']],
        '/api/2fa/verify-totp' => ['POST' => ['App\Controllers\TwoFactorController', 'verifyTotp']],
        '/api/2fa/verify-email' => ['POST' => ['App\Controllers\TwoFactorController', 'verifyEmail']],
        '/api/2fa/generate-backup-codes' => ['POST' => ['App\Controllers\TwoFactorController', 'generateBackupCodes']],
        '/api/2fa/complete-setup' => ['POST' => ['App\Controllers\TwoFactorController', 'completeSetup']],
        '/api/2fa/status' => ['GET' => ['App\Controllers\TwoFactorController', 'getStatus']],
        '/api/2fa/verify-email-login' => ['POST' => ['App\Controllers\TwoFactorController', 'verifyEmailLogin']],
        '/api/2fa/verify-totp-login' => ['POST' => ['App\Controllers\TwoFactorController', 'verifyTotpLogin']],
        '/api/2fa/verify-backup-code' => ['POST' => ['App\Controllers\TwoFactorController', 'verifyBackupCode']],

        // Admin 2FA routes
        '/api/admin/2fa/status' => ['GET' => ['App\Controllers\AdminController', 'getTwoFactorStatus']],
        '/api/admin/2fa/toggle-forced' => ['POST' => ['App\Controllers\AdminController', 'toggleForcedTwoFactor']],
